...
function SourcesList() {
    ...
    <?php
        ...
        $msg .= nc_core()->ui->btn(nc_module_path('netshop') . 'import.php', NETCAT_MODULE_NETSHOP_1C_INTEGRATION_IMPORT)->mini()->blue();
...
function SaveSource($id) {
    ...
    if ($source) {
        ...
        foreach ($settings as $item) {
            ...
            $value = $db->escape(htmlspecialchars($nc_core->input->fetch_post($item)));
