...
<div id="wrapper">
    <img class="form1" src="<?php echo nc_module_path('netshop') ?>forms/templates/russianpost_f116_page1.png" width="1000" height="1414" alt="Бланк сопроводительного адреса к посылке ф116" />
    <img class="form2" src="<?php echo nc_module_path('netshop') ?>forms/templates/russianpost_f116_page2.png" width="1000" height="1414" alt="Бланк сопроводительного адреса к посылке ф116 оборотная сторона" />
