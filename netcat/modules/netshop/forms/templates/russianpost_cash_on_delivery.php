...
<div id="wrapper">
    <img class="form1" src="<?php echo nc_module_path('netshop'); ?>forms/templates/russianpost_f113_page1.png" width="1000" height="1414" alt="Бланк почтового перевода наложенного платежа ф113эн" />
    <img class="form2" src="<?php echo nc_module_path('netshop'); ?>forms/templates/russianpost_f113_page2.png" width="1000" height="1414" alt="Бланк почтового перевода наложенного платежа ф113эн оборотная сторона" />
