...
<?php
    ...
    $fields = array(
        ...
        'AllowZeroPrice' => array(
            'type' => 'custom',
            'html' => '<div class="ncf_row">' .
                      '<input type="hidden" name="settings[AllowZeroPrice]" value="0">' .
                      '<label class="ncf_caption"><input type="checkbox" name="settings[AllowZeroPrice]" value="1"' .
                      ($netshop->get_setting('AllowZeroPrice') ? ' checked' : '') . "> &nbsp;" .
                      NETCAT_MODULE_NETSHOP_ALLOW_ZERO_PRICE .
                      "</label></div>\n",
            'wrap' => false,
        ),
