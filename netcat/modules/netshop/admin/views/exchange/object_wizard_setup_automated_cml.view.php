...
$table->add_row(NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_EXTERNAL_URL, $nc_core->url->get_host_url() . nc_module_path('netshop') . 'exchange/1c.php?id=' . $object->get('exchange_id'));
