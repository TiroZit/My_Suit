...
$row = $form->add_row(NETCAT_MODULE_NETSHOP_YANDEX_MARKET_BUNDLE_DELIVERY_COURIER)->style('display: inline-block;');
$row->select('data[delivery_courier_method_id]', $default_delivery_courier, $bundle->get('delivery_courier_method_id'));
