...
class nc_netshop_order_admin_controller extends nc_netshop_admin_controller {
     ...
     */
    protected function action_get_cart_discount_sum() {
        ...
        if (is_array($order_data)) {
            ...
            $context = new nc_netshop_condition_context($site_id);
            ...
            $cart_discount_sum = $discounts->set_context($context)->load_all_discounts()->get_discount_sum();
        
            $result['price'] = $cart_discount_sum;
        }
