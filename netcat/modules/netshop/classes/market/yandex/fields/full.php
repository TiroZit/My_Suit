...
class nc_netshop_market_yandex_fields_full extends nc_netshop_market_yandex_fields_type
{
  ...
  public function get_fields()
  {
    return array(
        ...
        'delivery_options_cost' => array('required' => false, 'editable' => true, 'parent_field' => 'delivery_options'),
        'delivery_options_days' => array('required' => false, 'editable' => true, 'parent_field' => 'delivery_options'),
        'delivery_options_order_before' => array('required' => false, 'editable' => true, 'parent_field' => 'delivery_options'),
        'delivery_options' => array('required' => false, 'editable' => false),
