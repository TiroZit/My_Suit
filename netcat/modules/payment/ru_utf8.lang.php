...
define("NETCAT_MODULE_PAYMENT_ADMIN_REGISTER_SETTINGS_EMAIL_FOR_RECEIPTS", "Адрес электронной почты продавца в чеке");
...
/* Yandex.Kassa */
define("NETCAT_MODULE_PAYMENT_YANDEX_KASSA_ERROR_SHOP_ID_IS_NOT_VALID", "Не указан параметр 'shop_id'");
define("NETCAT_MODULE_PAYMENT_YANDEX_KASSA_ERROR_SECRET_KEY_IS_NOT_VALID", "Не указан параметр 'secret_key'");
define("NETCAT_MODULE_PAYMENT_YANDEX_KASSA_ERROR_CREATING_PAYMENT", "Не удалось создать оплату в Яндекс.Кассе");

/* ЮKassa */
define("NETCAT_MODULE_PAYMENT_YOO_KASSA_ERROR_SHOP_ID_IS_NOT_VALID", "Не указан параметр 'shop_id'");
define("NETCAT_MODULE_PAYMENT_YOO_KASSA_ERROR_SECRET_KEY_IS_NOT_VALID", "Не указан параметр 'secret_key'");
define("NETCAT_MODULE_PAYMENT_YOO_KASSA_ERROR_CREATING_PAYMENT", "Не удалось создать оплату в ЮKassa");
...
/* Sberbank */
define("NETCAT_MODULE_PAYMENT_SBERBANK_ERROR_USER_NAME_IS_NULL", "Параметр 'user_name' должен быть установлен");
define("NETCAT_MODULE_PAYMENT_SBERBANK_ERROR_USER_PASSWORD_IS_NULL", "Параметр 'password' должен быть установлен");
