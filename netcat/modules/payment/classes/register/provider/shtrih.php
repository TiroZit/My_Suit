...
class nc_payment_register_provider_shtrih extends nc_payment_register_provider {
    ...
    static protected $shtrih_vat_enum = array(
        ...
        0 => 3,
        10 => 2,
        18 => 1, // в прошивках должна быть автокоррекция НДС с 01.01.2019
        20 => 1,
    );
    ...
    public function process_receipt(nc_payment_receipt $receipt) {
        ...
        foreach ($items as $item) {
            ...
            $data['str'][] = array(
                ...
                9 => 1,                                  // Признак способа расчета – числовое выражение (символы от 1 до 7)
                10 => $item->get('type')                 // Признак предмета расчета – числовое выражение (символы от 1 до 12)
            );
        }
