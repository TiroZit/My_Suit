...
class nc_payment_register_provider_komtetkassa extends nc_payment_register_provider {
    ...
    static protected $komtetkassa_default_vat = '20';
    ...
    static protected $komtetkassa_type_enum = array(
    ...
    public function __construct($site_id = null, $provider_id = null) {
        ...
        if (date('Y') < 2019) {
            self::$komtetkassa_default_vat = '18';
            self::$komtetkassa_vat_enum = array('' => 'no', 0 => '0', 10 => '10', 18 => '18');
        }
    }
    ...
    public function process_receipt(nc_payment_receipt $receipt) {
        ...
        foreach ($items as $item) {
            $data['positions'][] = array(
                ...
                'calculation_method' => 'pre_payment_full',
                'calculation_subject' => nc_array_value(self::$komtetkassa_type_enum, $item->get('type'), 'product'),
            );
        }
