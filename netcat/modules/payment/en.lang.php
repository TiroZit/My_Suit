...
/* Yandex.Kassa */
define("NETCAT_MODULE_PAYMENT_YANDEX_KASSA_ERROR_SHOP_ID_IS_NOT_VALID", "Parameter 'shop_id' is not set");
define("NETCAT_MODULE_PAYMENT_YANDEX_KASSA_ERROR_SECRET_KEY_IS_NOT_VALID", "Parameter 'secret_key' is not set");
define("NETCAT_MODULE_PAYMENT_YANDEX_KASSA_ERROR_CREATING_PAYMENT", "Unable to create Yandex.Checkout payment");

/* ЮKassa */
define("NETCAT_MODULE_PAYMENT_YOO_KASSA_ERROR_SHOP_ID_IS_NOT_VALID", "Parameter 'shop_id' is not set");
define("NETCAT_MODULE_PAYMENT_YOO_KASSA_ERROR_SECRET_KEY_IS_NOT_VALID", "Parameter 'secret_key' is not set");
define("NETCAT_MODULE_PAYMENT_YOO_KASSA_ERROR_CREATING_PAYMENT", "Unable to create Yoo.Kassa payment");
...
/* Sberbank */
define("NETCAT_MODULE_PAYMENT_SBERBANK_ERROR_USER_NAME_IS_NULL", "Field 'user_name' required");
define("NETCAT_MODULE_PAYMENT_SBERBANK_ERROR_USER_PASSWORD_IS_NULL", "Field 'password' required");